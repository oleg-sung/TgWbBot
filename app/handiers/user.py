...
async def cmd_start(message: Message):
    await message.answer(f"Здравствуйте {message.from_user.first_name}! 🖐🏻\n\n"
                         ...
                         "3⃣ Для просмотра истории поиска - Получить информацию из БД 💽", reply_markup=reply)
...
async def get_item_info(message: Message, state: FSMContext):
    ...
    await message.answer(f'Артикул товара состоит из 9 цифр ❗\nВведите артикул тавара 👇', reply_markup=reply)
